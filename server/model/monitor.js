...
class Monitor extends BeanModel {
    ...
    async start(io) {
        ...
        try {
            ...
            log.error("prometheus", "Prometheus update error: ", e.message);
        }
            ...
            try {
                if (await Monitor.isUnderMaintenance(this.id)) {
                    ...
                    if (this.cacheBust) {
                        ...
                        options.params = {
                            ravohost_cachebuster: cacheBust,
                        };
                    }
        ...
        const safeBeat = async () => {
            try {
                ...
                log.error("monitor", "Please contact support@ravohost.fr");
